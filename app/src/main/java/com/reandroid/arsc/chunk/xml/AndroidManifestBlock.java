...
public class AndroidManifestBlock extends ResXmlDocument implements AndroidManifest {
    ...
    public ResXmlElement removePermission(@Nullable String permissionName) {
        ...
        for (ResXmlElement permission : permissionList) {
            ...
            if (val.equals(permissionName)) {
                application.remove(permission);
                application.removeAttribute(nameAttr);
                manifestElement.remove(permission);
                manifestElement.removeAttribute(nameAttr);
                return permission;
            }
        }
        return null;
